...
class Game:
    ...
    def __init__(self):
        ...
        self.text_insert_coin = self.font.render(
            '<SPACE> - Insert coin', True, WHITE)
    ...
    def bucle_partida(self, dt):
        ...
        self.livesCounter = self.font.render(
            str(self.player.lives), True, WHITE)
